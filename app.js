...
function sumAndMultiply(a, b, c) { //eslint-disable-line
    ...
    var ResultofSum3Num = sum(global,c);
    var string1 = a + ' and  ' + b + '  and  ' + c  + ' sum to  ' + ResultofSum3Num + '.' ; 

    var ResultofPro2Num = multiply(a,b) ;
    var ResultofPro3Num = multiply(global,c);
    var string2 = ' The product of ' + a + '  and  ' + b + ' and  ' + c + ' is ' + ResultofPro3Num + '.' ; 

    return [  ' Result of sum Three Numbers = ' + ResultofSum3Num ,' Result of Multiply Three Numbers = ' + ResultofPro3Num , string1 , string2] ; 
}
